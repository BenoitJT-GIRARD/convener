...
const sample: Speaker = {
  ...
  selection: {
    ballots: [
      { voter: 'alice', value: 'yes', comment: '', coi_reason: '', date: '2026-01-01' },
      { voter: 'bob', value: 'yes', comment: 'happy to host', coi_reason: '', date: '2026-01-01' },
      { voter: 'carol', value: 'recused', comment: '', coi_reason: 'co-author', date: '2026-01-01' },
    ],
