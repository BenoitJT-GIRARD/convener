 ...
 *
 * Three of the four files `declarations/boundary.yml` hands to
 ...
 * `tools/convener_ops/maintenance/queue_watch.py` hold the same rules; they have to, because
 ...
 * `app/tests/settings/settings-bounds.test.ts` answers them from here. A bound this
