...
export const CONTENT_REGISTRY: Record<string, ContentEntry> = {
  ...
  // `handbook/the-workspace.md` with a plain relative link, but never
  ...
  'decisions/index': { file: 'engineering/decisions/index.md', anchor: null },
  'decisions/d-01': { file: 'engineering/decisions/d-01-repository-of-record.md', anchor: null },
  'decisions/d-02': { file: 'engineering/decisions/d-02-participant-data-encryption.md', anchor: null },
  'decisions/d-03': { file: 'engineering/decisions/d-03-github-app-device-flow.md', anchor: null },
  'decisions/d-04': { file: 'engineering/decisions/d-04-concurrent-writes.md', anchor: null },
  'decisions/d-05': { file: 'engineering/decisions/d-05-meeting-platform-abstraction.md', anchor: null },
  'decisions/d-06': { file: 'engineering/decisions/d-06-registration-ownership.md', anchor: null },
  'decisions/d-07': { file: 'engineering/decisions/d-07-email-channels.md', anchor: null },
  'decisions/d-08': { file: 'engineering/decisions/d-08-visuals-generated-in-ci.md', anchor: null },
  'decisions/d-09': { file: 'engineering/decisions/d-09-no-linkedin-automation.md', anchor: null },
  'decisions/d-10': { file: 'engineering/decisions/d-10-youtube-channel-ownership.md', anchor: null },
  'decisions/d-11': {
    file: 'engineering/decisions/d-11-organisation-accounts-and-vault.md',
    anchor: null,
  },
  'decisions/d-12': { file: 'engineering/decisions/d-12-no-automatic-transcription.md', anchor: null },
  'decisions/d-13': { file: 'engineering/decisions/d-13-deferred-configuration.md', anchor: null },
  'decisions/d-14': { file: 'engineering/decisions/d-14-language-boundary.md', anchor: null },
  'decisions/d-15': { file: 'engineering/decisions/d-15-publication-topology.md', anchor: null },
  'decisions/d-16': { file: 'engineering/decisions/d-16-brand-source-of-truth.md', anchor: null },
  'decisions/d-17': { file: 'engineering/decisions/d-17-typography-substitution.md', anchor: null },
  'decisions/d-18': { file: 'engineering/decisions/d-18-static-pages-with-islands.md', anchor: null },
  'decisions/d-19': { file: 'engineering/decisions/d-19-event-identifier.md', anchor: null },
  'decisions/d-20': { file: 'engineering/decisions/d-20-certificate-wire-format.md', anchor: null },
  'decisions/d-21': { file: 'engineering/decisions/d-21-certificate-lifecycle.md', anchor: null },
  'decisions/d-22': { file: 'engineering/decisions/d-22-key-destruction-not-deletion.md', anchor: null },
  'decisions/d-23': { file: 'engineering/decisions/d-23-encrypted-record-envelope.md', anchor: null },
  'decisions/d-24': {
    file: 'engineering/decisions/d-24-operator-commands-name-things.md',
    anchor: null,
  },
  'decisions/d-25': { file: 'engineering/decisions/d-25-loud-failure.md', anchor: null },
  'decisions/d-26': { file: 'engineering/decisions/d-26-verify-deployed-shape.md', anchor: null },
  'decisions/d-27': { file: 'engineering/decisions/d-27-pin-the-render-engine.md', anchor: null },
  'decisions/d-28': {
    file: 'engineering/decisions/d-28-architect-and-board-permissions.md',
    anchor: null,
  },
  'decisions/d-29': {
    file: 'engineering/decisions/d-29-licence-and-attribution.md',
    anchor: null,
  },
  ...
  // announcement e-mail. This is the participant confirmation the
  // registration pipeline sends
  ...
  // by tools/convener_ops/journey/survey_invite.py and sent by an operator dispatching
  ...
  'handbook/workspace': { file: 'handbook/the-workspace.md', anchor: null },
  'handbook/tools': { file: 'handbook/tools.md', anchor: null },
  'handbook/contacts': { file: 'handbook/contacts.md', anchor: null },

  // engineering -- the record model, generated from `app/src/data/types.ts`
  // and refused by continuous integration when the two drift. Served here
  // rather than left to the repository because a board member reading a
  // record wants the field list without opening the types; keyed after the
  // tree it is in, the way `decisions/*` is, because a key opening
  // `handbook/` over a file in another tree is a claim about where the page
  // lives that the page does not honour.
  'engineering/schema': { file: 'engineering/schema.md', anchor: null },
