...
| **The meeting platform** | Hosting the webinar and recording it | The organisation's own account — see [Operations](https://github.com/example-instance/example-cockpit/blob/main/docs/reference/operations.md#meeting-platform) |
| **The video channel** | Publishing the recordings | The organisation's own account — see [Operations](https://github.com/example-instance/example-cockpit/blob/main/docs/reference/operations.md#video-channel) |
