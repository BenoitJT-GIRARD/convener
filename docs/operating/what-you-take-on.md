...
[`TRADEMARK.md`](../../TRADEMARK.md) says what a fork renames and how little
an unregistered mark is actually worth. Both the showcase and the cockpit
display the licence notice in their footer; its text is `NOTICE.json`, and
no part of it is an instance's to configure.
