...
*Posted after the webinar, as a reply under the announcement thread. It is a summary of the discussion — not a word-for-word transcript.*

## How to make it

1. Save the Zoom live transcript of the discussion.
2. Ask an AI tool to summarise it, using the prompt below.
3. Read it through, edit, and post it under the announcement thread.
