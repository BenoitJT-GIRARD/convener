...
# needing four voices to agree. G-14 sets that window at twelve months and
...
# settles the question (G-14). Coming back costs one word in one field.
#
# `sweep_inactive_members` is a pure function. `cli._report_inactivity` calls
# it -- detection is what the scheduled task operates (G-14) -- and prints the
