...
Public showcase of TEC Monthly Reading Group — and nothing else.

**This repository holds no source.** Everything under it is generated and pushed by
the private `example-instance/example-cockpit` repository's CI (D-15: private source, public artefact):
...
workflow. To change the showcase, edit the templates under `example-instance/example-cockpit`'s own
